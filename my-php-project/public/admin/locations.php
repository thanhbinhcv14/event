                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="locationPrice" name="GiaThue" min="0" step="1000" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <table class="table table-sm">
                                    ...
                                    <tr><td><strong>Giá thuê:</strong></td><td>${AdminPanel.formatCurrency(location.GiaThue)}</td></tr>
